...
export const Post: FC = () => {
  ...
  return (
    <Card sx={{ marginY: 5 }}>
      ...
      />
      <CardMedia component="img" height="194" image={'./social/card-01.jpg'} alt="Paella dish" />
      <CardContent>
      ...
      <CardActions disableSpacing>
        <Checkbox icon={<FavoriteBorderIcon />} checkedIcon={<FavoriteIcon sx={{ color: red[600] }} />} />
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          ...
          <Typography paragraph>
            ...
            thickened and fragrant, about 10 minutes. Add saffron broth and remaining 4 1/2 cups chicken
